    ...
    <div class="news">
        <MyHead></MyHead>
            ...
            <div class="news_module">
                ...
                <div class="tree_menu">
                <ul>
                    <li><router-link  class="active"  to="/news"><i class="t2"></i>新闻动态</router-link></li>
                    <li><router-link to="/knowledge"><i class="t2"></i>产品知识</router-link></li>
                </ul>
                </div>
...
export default {
  ...
  created(){
      ...
      var that = this;
        ...
        this.$axios.get(`http://admin.hdjrrj.com/home/index/new_list?mycode=${mycode}&aid=1`,)
            .then(function (res) {
