...
export default {
  ...
  data() {
    return {
        ...
        //     //图片信息（必需）
        //     imgData: [
        //         {href: "#",src: "/static/img/a.png"},
        //         {href: "#",src: "/static/img/b.png"},
        //         {href: "#",src: "/static/img/c.png"},
        //         {href: "#",src: "/static/img/d.png"}
        //     ],
        //     time: 2000               //轮播图延时（可选）
        // }
    }
...
(function (w) {
        ...
        _createNode: function () {
            ...
            for (var i = 0; i < this.imgData.length; i++) {
                ...
                img.onload = function () {
                    ...
                    _this.bigBox.style.width = "100%";
                    _this.ctrlBox.style.width ="100%";
                    _this.bigBox.style.height = "100%";
                    _this.ctrlBox.style.height = "100%";
  ...
  mounted(){
      new Carousel("carousel",this.opts);
  }
}
</script>
